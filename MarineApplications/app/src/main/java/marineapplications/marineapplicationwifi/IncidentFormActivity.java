...
/**
 * The type Incident form activity.
 */
public class IncidentFormActivity extends AppCompatActivity {
    ...
    private Spinner incidenttypeedit;
    private EditText incidentdetailsedit;
    private EditText incidentactionedit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.incidenttext);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(IncidentFormActivity.this, DashboardActivity.class);
        ...
        incidentdetailsedit = (EditText) findViewById(R.id.edit_text_incident_details);
        incidentactionedit = (EditText) findViewById(R.id.edit_text_incident_action);
        incidenttypeedit = (Spinner) findViewById(R.id.incidenttypespinner);
        ...
        dateedit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                confclass.hideSoftKeyboard(IncidentFormActivity.this);
                ...
                mDatePicker = new DatePickerDialog(IncidentFormActivity.this, new DatePickerDialog.OnDateSetListener() {
    ...
    private void submit_current_form() {
        ...
        incidentdetailsedit.setError(null);
        incidentactionedit.setError(null);

        // Store values at the time of the login attempt.
        String datepicker = dateedit.getText().toString();
        String incidentdetails = incidentdetailsedit.getText().toString();
        String incidentaction = incidentactionedit.getText().toString();
        String incidenttype = incidenttypeedit.getSelectedItem().toString();

        boolean cancel = false;
        View focusView = null;

        // Check if entity is empty.
        if (TextUtils.isEmpty(incidentdetails)) {
            incidentdetailsedit.setError(getString(R.string.error_field_required));
            focusView = incidentdetailsedit;
            cancel = true;
        }

        // Check if entity is empty.
        if (TextUtils.isEmpty(incidentaction)) {
            incidentactionedit.setError(getString(R.string.error_field_required));
            focusView = incidentactionedit;
            cancel = true;
        }
        ...
        if (cancel) {
            ...
            mTripTask = new TripUploadTask(newdatepicker, incidenttype, incidentdetails, incidentaction);
            mTripTask.execute();
        }
    }
    ...
    public class TripUploadTask extends AsyncTask<Void, Void, JSONObject> {
        ...
        private final String mincidentdetails;
        private final String mincidentactions;
        /**
         * The Insertdb.
         */
         ...
         * @param incidentDetails the incident details
         * @param incidentAction  the incident action
         */
        TripUploadTask(String datepick, String incidentType, String incidentDetails, String incidentAction) {
            mdate = datepick;
            mincidenttype = incidentType;
            mincidentdetails = incidentDetails;
            mincidentactions = incidentAction;
            confclass = new Configure_Class();
        ...
        protected JSONObject doInBackground(Void... args) {
            try {
                ...
                if (confclass.isConnectedToInternet()) {
                    ...
                    params.put("system_request", "upload_incident");
                    params.put("trip_id", online_trip_id);
                    params.put("incident_type", mincidenttype);
                    params.put("incident_details", mincidentdetails);
                    params.put("incident_action", mincidentactions);
                    ...
                    try {
                        insertresult = insertdb.IncidentRecordInsertDB(context, mdate, mincidenttype, mincidentdetails, mincidentactions, trip_id, user_id);
