...
/**
 * The type Lost gear activity.
 */
public class LostGearActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lost_gear);

        //Toolbar of Page
        Toolbar toolbar = (Toolbar) findViewById(R.id.temptoolbar);
        toolbar.setNavigationIcon(R.drawable.abc_ic_ab_back_material);
        toolbar.setTitle(R.string.lostgeartext);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(LostGearActivity.this, DashboardActivity.class);
        ...
        dateedit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Hide the keyboard
                confclass.hideSoftKeyboard(LostGearActivity.this);
                ...
                mDatePicker = new DatePickerDialog(LostGearActivity.this, new DatePickerDialog.OnDateSetListener() {
